...
// AdServiceClient is the client API for Service service.
//
...
func (c *adServiceClient) CreateAd(ctx context.Context, in *CreateAdRequest, opts ...grpc.CallOption) (*AdResponse, error) {
	out := new(AdResponse)
	err := c.cc.Invoke(ctx, "/ad.Service/CreateAd", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adServiceClient) ChangeAdStatus(ctx context.Context, in *ChangeAdStatusRequest, opts ...grpc.CallOption) (*AdResponse, error) {
	out := new(AdResponse)
	err := c.cc.Invoke(ctx, "/ad.Service/ChangeAdStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adServiceClient) UpdateAd(ctx context.Context, in *UpdateAdRequest, opts ...grpc.CallOption) (*AdResponse, error) {
	out := new(AdResponse)
	err := c.cc.Invoke(ctx, "/ad.Service/UpdateAd", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adServiceClient) GetAdByID(ctx context.Context, in *GetAdRequest, opts ...grpc.CallOption) (*AdResponse, error) {
	out := new(AdResponse)
	err := c.cc.Invoke(ctx, "/ad.Service/GetAdByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adServiceClient) CreateUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/ad.Service/CreateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adServiceClient) GetUser(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/ad.Service/GetUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adServiceClient) DeleteUserByID(ctx context.Context, in *DeleteUserRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/ad.Service/DeleteUserByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adServiceClient) DeleteAdByAuthorID(ctx context.Context, in *DeleteAdRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/ad.Service/DeleteAdByAuthorID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// AdServiceServer is the server API for Service service.
...
func _AdService_CreateAd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ad.Service/CreateAd",
	}
...
func _AdService_ChangeAdStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ad.Service/ChangeAdStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AdService_UpdateAd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ad.Service/UpdateAd",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AdService_GetAdByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ad.Service/GetAdByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AdService_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ad.Service/CreateUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AdService_DeleteUserByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ad.Service/DeleteUserByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AdService_DeleteAdByAuthorID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ad.Service/DeleteAdByAuthorID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
// AdService_ServiceDesc is the grpc.ServiceDesc for Service service.
